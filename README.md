...
This repository was created with the intent of teaching us the basic concepts of OOP in ruby and much more.
...
**OOP-school-library** is a repository that will include various ruby files in order to create a project that will in the future add new records of people, books and borrowed books.
